...
public class LessonServiceImpl implements LessonService {
    ...
    @Override
    public List<LessonResponseDto> findAllByModuleId(Long moduleId) {
        ModuleEntity module = moduleService.findById(moduleId);
        log.info("Get all lessons by module id: {}", module.getId());
        Set<LessonEntity> lessons = module.getLessons();
        List<LessonResponseDto> lessonResponseDtos = new ArrayList<>();
        for (LessonEntity lesson : lessons) {
            lessonResponseDtos.add(convertToResponseDto(lesson, false));
        }
        log.info("Get all lessons by module id: {}", module.getId());
